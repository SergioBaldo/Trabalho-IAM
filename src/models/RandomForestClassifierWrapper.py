...
class RandomForestClassifierWrapper:
    def __init__(
        ...
        Args:
            ...
            best_features (list): List of feature names to be used for training.
            n_estimators (int): Number of trees in the Random Forest (default is 100).
            random_state (int): Random seed for reproducibility (default is SEED).
        """
    ...
    def train_and_evaluate(self):
        """
        Load the dataset, train a Random Forest model, and return evaluation metrics.

        Returns:
            accuracy (float): Balanced Accuracy of the Random Forest model.
            f1_score_weighted (float): Weighted F1 Score of the Random Forest model.
            conf_matrix (array): Confusion matrix of the Random Forest model.
        """
        # Load the dataset
